...
const LugaresLineal = ({borderColor, buttonStyle, link_ceremonia, link_fiesta}) => {
  ...
  const lugares = [
    {
      ...
      descripcion: (
        <>
          Viernes 31 de Octubre de 2025 a las 11:30hs<br />
          <strong>Registro Civil Uspallata</strong>
        </>
      ),
    },
    {
      ...
      descripcion: (
        <>
          Viernes 31 de Octubre de 2025 a las 21:30hs<br />
          <strong>Restaurante Nos Sobran Los Motivos</strong><br/>
          Puntualidad para recibir a los novios a las 22hs
        </>
      ),
    },
  ];
